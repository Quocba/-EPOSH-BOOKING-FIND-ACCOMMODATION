...
namespace GraduationAPI_EPOSHBOOKING.DataAccess
{
    public class DBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=SQL8005.site4now.net;Initial Catalog=db_aaa284_eposhbooking;User Id=db_aaa284_eposhbooking_admin;Password=Admin123@;Trust Server Certificate=True");
